    ...
    (p.ClassBody = function () {
        ...
        (p.ClassNavMenu = function () {
            p.BreakClass("." + s, d.lg, { timeOut: 0 }),
                ...
                c.on("resize", function () {
                    p.BreakClass("." + s, d.lg), p.BreakClass("." + r, d.lg, { classAdd: t });
                });
        }),
        (p.Prettify = function () {
        ...
        (p.Toast = function (e, t, n) {
            ...
            (n.position = n.position ? "toast-" + n.position : "toast-bottom-right"),
                ...
                "" !== (e = "" !== e ? o + '<div class="toastr-text">' + e + "</div>" : "") &&
        ...
        (p.TGL.showmenu = function (e, t) {
            var n = x(e || ".nk-nav-toggle"),
                ...
                e = { active: "toggle-active", content: r + "-active", body: "nav-shown", overlay: "nk-sidebar-overlay", break: o, close: { profile: !0, menu: !1 } },
                i = t ? u(e, t) : e;
            ...
            x(a).exists() &&
                x(a).each(function () {
                    var e = x(a).data("max-files") || null,
                        ...
                        url = x(this).data("url") || "/uploads", // Default URL if not set
                        e = { 
                            autoDiscover: !1, 
                            maxFiles: e, 
                            maxFilesize: t, 
                            acceptedFiles: n || null, 
                            url: url // Use the fetched URL
                        },
                        t = o ? u(e, o) : e;
                    // Remove any existing Dropzone instance before initializing
                    if (x(this).hasClass("dropzone")) {
        ...
        (p.Dropzone.init = function () {
            p.Dropzone(".upload-zone"); // Initialize Dropzone
        }),
        ...
        (p.DataTable.init = function () {
            p.DataTable(".datatable-init", { responsive: { details: !0 } }),
                p.DataTable(".datatable-init-export", { responsive: { details: !0 }, buttons: ["copy", "excel", "csv", "pdf", "colvis"] }),
            ...
            x(e || ".dropdown-menu").on("click", function (e) {
                ...
                p.State.isRTL &&
                    x(".dropdown-menu").each(function () {
                        var e = x(this);
                        e.hasClass("dropdown-menu-right") && !e.hasClass("dropdown-menu-center")
                            ? e.prev('[data-toggle="dropdown"]').dropdown({ popperConfig: { placement: "bottom-start" } })
                            : e.hasClass("dropdown-menu-right") || e.hasClass("dropdown-menu-center") || e.prev('[data-toggle="dropdown"]').dropdown({ popperConfig: { placement: "bottom-end" } });
                    });
        }),
                ...
                a[t].addEventListener("click", function () {
                    ...
                    s.forEach(function (e, t, n) {
                        ...
                        s[t].classList.contains("number-spinner") &&
                            ((a = "" == !s[t].value ? parseInt(s[t].value) : 0), (o = "" == !s[t].step ? parseInt(s[t].step) : 1), (i = "" == !s[t].max ? parseInt(s[t].max) : 1 / 0), (s[t].value = a + o < i + 1 ? a + o : a));
                    });
                });
            }),
                o.forEach(function (e, t, n) {
                    ...
                    o[t].addEventListener("click", function () {
                        ...
                        s.forEach(function (e, t, n) {
                            var a, o, i;
                            s[t].classList.contains("number-spinner") &&
                                ((a = "" == !s[t].value ? parseInt(s[t].value) : 0), (o = "" == !s[t].step ? parseInt(s[t].step) : 1), (i = "" == !s[t].min ? parseInt(s[t].min) : 0), (s[t].value = i - 1 < a - o ? a - o : a));
                        });
                    });
                });
        }),
        (p.Custom.Stepper = function (n, e) {
            ...
            function k(e) {
                ...
                1 === t && ((c.style.display = "block"), (r.style.display = "none"), (l.style.display = "none"), n.setAttribute("data-step-current", "first")),
                    ...
                    b && ((i.innerHTML = "".concat(e, " of ").concat(h)), (s.style.width = "".concat((100 / h) * e, "%")));
            }
