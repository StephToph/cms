                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title"><?=translate_phrase('Dedication Archive');?></h3>
                            <div class="nk-block-des text-soft">
                                <p><?=translate_phrase('You have total');?> <span id="counta"></span> <?=translate_phrase('dedication archive(s).');?></p>
                            </div>
...
<script>
    ...
    function load(x, y) {
        ...
        $.ajax({
            url: site_url + 'dedication/archive/load' + methods,
            type: 'post',
            data: { search: search },
