                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title"><?=translate_phrase('Dedication');?></h3>
                            <div class="nk-block-des text-soft">
                                <p><?=translate_phrase('You have total');?> <span id="counta"></span> <?=translate_phrase('dedication list(s).');?></p>
                            </div>
                                    ...
                                    <div class="card-tools me-n1">
                                        <ul class="btn-toolbar gx-1">
                                            ...
                                            <?php if(empty($switch_id)){?>
                                                ...
                                                <li>
                                                    <a href="javascript:;" pageTitle="Add Dedication"
                                                        class="btn btn-outline-primary btn-icon pop"
                                                        pageName="<?= site_url('dedication/list/manage'); ?>" pagesize="modal-lg"><em
...
<script>
    ...
    function load(x, y) {
        ...
        $.ajax({
            url: site_url + 'dedication/list/load' + methods,
            type: 'post',
            data: { search: search },
