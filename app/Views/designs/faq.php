                ...
                <div class="nk-block-head nk-block-head-lg wide-xs mx-auto">
                    <div class="nk-block-head-content text-center">
                        ...
                        <div class="nk-block-des">
                            <p class="lead">Got a question? Can't find the answer you're looking for? Don't worry, drop us a line on our <a href="<?=site_url('support/list'); ?>">contact page</a>.</p>
                        </div>
                    </div>
                </div><!-- .nk-block-head -->
                <div class="nk-block">
                        ...
                        <div id="faqs" class="accordion">
                            <div class="accordion-item">
                                <a href="#" class="accordion-head" data-bs-toggle="collapse" data-bs-target="#faq-q1">
                                    <h6 class="title">What is <?=app_name; ?>?</h6>
                                    <span class="accordion-icon"></span>
                                </a>
                                <div class="accordion-body collapse show" id="faq-q1" data-bs-parent="#faqs">
                                    <div class="accordion-inner">
                                        <p>An overview of <strong><?=app_name; ?></strong> – is fully clean and premium designed admin template which included beautiful hand-crafted components & elements. <strong><?=app_name; ?></strong> completely focusing on <strong>conceptual base apps</strong> or dashboard, as it’s equipped with pre-built screens as well.</p>
                                        <p><strong><?=app_name; ?></strong> is powerful <strong>admin dashboard</strong> template that especially build for developers and programmers. <strong><?=app_name; ?></strong> comes with all kind of components, necessary elements and pre-build pages including <strong>3 conceptual apps</strong> screen that helps you to create your web apps or application. </p>
                                    </div>
                                </div>
                            </div><!-- .accordion-item -->
                            <div class="accordion-item">
                        ...
                        <div class="card-inner">
                            <div class="align-center flex-wrap flex-md-nowrap g-4">
                                ...
                                <div class="nk-block-content flex-shrink-0">
                                    <a href="<?=site_url('suppport/list'); ?>" class="btn btn-lg btn-outline-primary">Get Support Now</a>
                                </div>
                            </div>
                        </div><!-- .card-inner -->
                    </div><!-- .card -->
