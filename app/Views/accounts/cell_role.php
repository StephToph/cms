                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title"><?=translate_phrase('Cell Roles');?></h3>
                            <div class="nk-block-des text-soft">
                                <p><?=translate_phrase('You have total');?> <span id="counta"></span> <?=translate_phrase('role(s).');?></p>
                            </div>
                                ...
                                <div class="card-title-group">
                                    ...
                                    <div class="card-tools me-n1">
                                        <ul class="btn-toolbar gx-1">
                                            ...
                                            <li>
                                                <a href="javascript:;" pageTitle="Add Role" class="btn btn-outline-primary btn-icon pop" pageName="<?=site_url('accounts/cell_role/manage'); ?>"><em class="icon ni ni-plus-c"></em></a>
                                            </li><!-- li -->
...
<script>
    ...
    function load(x, y) {
        ...
        $.ajax({
            url: site_url + 'accounts/cell_role/load' + methods,
            type: 'post',
            data: { search: search },
