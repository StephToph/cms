                    ...
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            ...
                            <div class="nk-block-des text-soft">
                                <p><?=translate_phrase('You have total');?> <span id="counta"></span> <?=translate_phrase('ministry.');?></p>
                            </div>
                                ...
                                <div class="card-title-group">
                                    ...
                                    <div class="card-tools me-n1">
                                        <ul class="btn-toolbar gx-1">
                                            ...
                                            <li>
                                                <a href="javascript:;" pageTitle="Add Ministry" class="btn btn-outline-primary btn-icon pop" pageName="<?=site_url('ministry/index/manage'); ?>"><em class="icon ni ni-plus-c"></em></a>
                                            </li><!-- li -->
