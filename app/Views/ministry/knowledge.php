                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">Knowledge Base</h3>
                            <div class="nk-block-des text-soft">
                                <p>You have total <span id="counta"></span> knowledge base.</p>
                            </div>
                                ...
                                <div class="card-title-group">
                                    ...
                                    <div class="card-tools me-n1">
                                        <ul class="btn-toolbar gx-1">
                                            ...
                                            <li>
                                                <a href="javascript:;" pageName="<?=site_url('ministry/knowledge/manage'); ?>" pageTitle="Add" pageSize="modal-sm" class="btn btn-icon btn-outline-primary pop"><em class="icon ni ni-plus-c"></em></a>
                                            </li>
                                        </ul><!-- .btn-toolbar -->
                                    </div><!-- .card-tools -->
...
<script>
    ...
    function load(x, y) {
        ...
        $.ajax({
            url: site_url + 'ministry/knowledge/load' + methods,
            type: 'post',
            data: {search: search },
