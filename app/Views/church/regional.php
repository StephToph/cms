                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title"><?=translate_phrase('Regional Churches');?></h3>
                                ...
                                <div class="card-title-group">
                                    ...
                                    <div class="card-tools me-n1">
                                        <ul class="btn-toolbar gx-1">
                                            ...
                                            <li>
                                                <a href="javascript:;" pageTitle="Add Church" class="btn btn-outline-primary btn-icon pop" pageName="<?=site_url('church/regional/manage'); ?>"><em class="icon ni ni-plus-c"></em></a>
                                            </li><!-- li -->
...
<script>
    ...
    function load(x, y) {
        ...
        $.ajax({
            url: site_url + 'church/regional/load' + methods,
            type: 'post',
            data: { search: search },
