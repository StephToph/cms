                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title"><?=translate_phrase('Zonal Churches');?></h3>
                                ...
                                <div class="card-title-group">
                                    ...
                                    <div class="card-tools me-n1">
                                        <ul class="btn-toolbar gx-1">
                                            ...
                                            <li>
                                                <a href="javascript:;" pageTitle="Add Church" class="btn btn-outline-primary btn-icon pop" pageName="<?=site_url('church/zonal/manage'); ?>"><em class="icon ni ni-plus-c"></em></a>
                                            </li><!-- li -->
                                           <?php } ?>
                                        </ul><!-- .btn-toolbar -->
                                    </div><!-- .card-tools -->
...
<script>
    ...
    function load(x, y) {
        ...
        $.ajax({
            url: site_url + 'church/zonal/load' + methods,
            type: 'post',
            data: { search: search },
            success: function (data) {
                var dt = JSON.parse(data);
